...
public class CalendarGUI extends javax.swing.JFrame {
	...
	//They used simple java library representation instead of needing the strings.
	//This refactoring allows for internationalization to be able to work.
	//The refactoring was successful and the code looks a lot nicer.
	...
	//SWAP 2, TEAM 4
	//REFACTORING FOR ENHANCEMENT FROM BAD SMELL
	//We used fowler's solution of "Extract Method"
	//This refactoring will help users be able to read the code easier which
	//can enable more changes on the UI.
	//This was successful and helps the code be more readable.
