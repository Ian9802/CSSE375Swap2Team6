...
public class Schedule extends Thread implements Serializable {
                ...
                for (Day day : this.days) {
                     ...
                     if (this.cal.get(Calendar.DAY_OF_WEEK) == this.numForName(day
                           ...
                           for (String job : jobsInOrder) {                     
                        	   ...
                        	   /*
                        	    * QUALITY CHANGES
                        	    * created jobWorkers to get the list of people who can work that certain job
                        	    */
                                ArrayList<Worker> workersForJob = jobWorkers(job, day, workersWorking);
                                
                                if (workersForJob.size() > 0) {
                                     Worker workerForJob = getWorkers(job, workersForJob);
	...
	private Worker getWorkers(String job, ArrayList<Worker> workersForJob) {
